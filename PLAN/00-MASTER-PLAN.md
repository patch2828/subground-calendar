# 00 — MASTER PLAN
## SubGround Collective · Sept 2026 → Feb 2027 · target $100,000 net

Built 2026-08-26 off `FACTS.md` (verified fact base) and `SLATE.md` (canonical nine-show slate).
Every dollar below is either **VERIFIED** (traceable to a line in FACTS.md) or **ESTIMATE / Claude's model** (arithmetic shown so Ryan can check it). Nothing is a placeholder. Where a number does not exist, this document says it does not exist.

**Ryan makes every payment. Claude never moves money. That holds on every line in this plan.**

---

## 1. THE THESIS

The existing roadmap ladder does not get to $100,000, and pretending otherwise wastes the six months.

**What the ladder actually adds up to, using only numbers that exist in FACTS.md:**

| Rung | Net | Source |
|---|---|---|
| Sept 10 Gold Rush Pre-Party, at full sellout | **+$13,630** | VERIFIED, FACTS §7 (modeled 8/25: revenue ~$23,409, costs $9,779) |
| Icehouse Content Night | **−$2,500** | VERIFIED, FACTS §8. Ryan's binding correction 8/22: **NOT a revenue event.** $2k room + ~$500 mapping/lasers, free door, zero ticket revenue |
| Nov 6 Combine × Northern Road | **no net figure exists** | Venue rate still pending. Unknown, needs Synesthesia to confirm the Friday rate |
...
**Stated plainly, what has to be true:**
...
**What it is FOR:** it is the bankroll. Nothing else in this window is funded until this show runs. GALLIUM is signed (AB Touring contract #10786, $1,250, **$625 deposit already paid 8/25**, balance $625 cash day-of after performance).

**What it funds:** Icehouse's $2,000 room fee, and the Oct 31 venue deposit. Both. FACTS §8 is explicit that Icehouse is funded by Sept 10 proceeds and must not be signed, committed, or promised before Sept 10 without Ryan's OK.

**The number that matters:** **236 tickets covers the entire deferred cost pile. That is 18% of capacity.** Breakeven is 575 tickets, 44% of capacity. Everything above 575 is the Q4 war chest.

### 02 · Fri Sept 18 or Sat Sept 19 — ICEHOUSE CONTENT NIGHT · The Icehouse · ~100
Awaiting Sam (sam@openvenues.com), inquiry sent 8/11. **No artist constraint requires the 19th.** Let Sam's availability decide.

**What it is FOR:** content and relationships. **It is NOT revenue and must never be modeled as profit anywhere.** Free door. Ten roster artists, 15-minute sets back to back, projection-mapped walls and lasers, RAW within 48 hours, curated edit over two weeks.

**What it funds:** the sponsor deck, the ad creative for Oct 31 and Nov 6, and the roster's loyalty. A free shoot for the freshmen roster is how Law 4 gets paid forward: today's $150 vendors and unpaid-set artists are DREAM's department heads.

**It is a cost line. Budget −$2,500 and treat it as marketing spend, because that is what it is.**
...
**What it funds:** NYE's balance payment and the January deposit. A small, safe, fast show sitting three weeks before the biggest night of the year is exactly the right shape.

### 06 · Thu Dec 31 — NEW YEAR'S EVE · 1,000-cap · TO BOOK
**Fattest night of the year.** Dec 31 2026 is a Thursday and Jan 1 is a Friday holiday, so people go out and stay out. Double pricing is normal on NYE and nobody blinks.

**What it is FOR:** the single largest indoor number in the window. In the roadmap it carries +$8k to +$15k, and that band is achievable at the Law 3 floor of 70% sold (see the model in section 3, which lands at ~$13,000 at 70%).

**What it funds:** the January and February deposits, and the Drive-In's down payment. February 20 is the most expensive show on the slate and NYE money is what makes it bookable.

**Open:** no venue, no lineup, no date lock. A reply aiming Walter Productions at December/NYE is DRAFTED and awaiting Ryan's "send it." Note for that conversation: **Walter runs ticketing, box office AND security** (full service), which kills any bring-your-own assumption but also removes three cost lines.

### 07 · Sat Jan 23 — JANUARY HEADLINE · 1,000-cap · TO BOOK
**What it is FOR:** keeping the machine warm. January is dead in Phoenix nightlife and a headline show that runs anyway is how you own the month. This is also the first show where the SMS list and the SIGNAL 001 buyer base should be doing real work instead of ads.

**What it funds:** Feb 13's talent and the Drive-In's production deposit.

### 08 · Sat Feb 13 — FEBRUARY HEADLINE (Valentine's weekend) · 1,000-cap · TO BOOK
**What it is FOR:** an easy sell with a pricing structure nobody argues with. Couples pricing, two-for pricing, table pricing. Low creative lift, high conversion.
...
### Floating adds, real pipeline, no date
- **PRESCOTT (Renegade / Prototype)**, 300 to 500, blocked on Josh (Auxlee, Funky Forest). Slot it the moment he answers.
- **CHEBA HUT**, deck delivered, window passed unlocked. Re-pitch as a Light House-style Thursday.
- **TUNNEL RAVE (Surprise AZ)**, Srija's scouting. Teasers only, **never the location, ever.**
- **PICACHO PEAK**, pack built, backburner.

---

## 3. THE MODEL — how nine shows reach $100,000

**This entire section is Claude's model. Every row is an ESTIMATE except where marked VERIFIED. Ryan should check the arithmetic and overwrite any assumption he disagrees with.**

**Assumptions, stated up front:**

- **A1 (VERIFIED, FACTS §4):** Shotgun takes ~11%. $15 face nets $13.33, $20 face nets $17.78. That is a net factor of **0.889**. Applied to other prices: $25 → $22.23 · $30 → $26.67 · $40 → $35.56 · $50 → $44.45.
...
| # | Show | Cap | Price (adv/door) | Net/ticket | Cost envelope | **Net @ 70%** | **Net @ 100%** |
|---|---|---|---|---|---|---|---|
| 01 | Sept 10 Gold Rush | 1,300 | $15 EB / $20 GA | $13.33 / $17.78 | **$9,779 VERIFIED** | **$6,406** | **$13,630 VERIFIED** |
| 02 | Icehouse | ~100 | free | n/a | **−$2,500 VERIFIED** | **−$2,500** | **−$2,500** |
| 03 | Oct 31 Halloween | 1,000 | $25 / $30 | $22.23 / $26.67 | $12,000 EST | **$5,115** | **$13,116** |
| 04 | Nov 6 Combine × N.Road | 1,000 | $25 / $30 | $22.23 / $26.67 | $12,000 EST | **$5,115** | **$13,116** |
| 05 | Dec 12 TH3 N3TW0RK | 600 | $20 / $25 | $17.78 / $22.23 | $5,000 EST | **$3,402** | **$7,404** |
...
## 4. THE FOUR REVENUE LAYERS

Pipeline Law 3: **budget to break even on tickets alone at 70% sold. Vendors, merch and sponsors are profit, never survival.** Here is where each layer actually stands today.

| Layer | Status today | Verified evidence | Ceiling |
|---|---|---|---|
| **1. Tickets** | The only layer with real economics | $19.30 realized net per ticket on SIGNAL 001 ($2,740 across 142 tickets). Shotgun ~11%. Breakeven ad conversion 0.92% | Hard-capped by room capacity |
| **2. Vendors** | $450 confirmed, total, across six months | 3 spots × $150 on Sept 10, due Sept 3. Pitch is "vendor keeps 100% of sales, no cut" | Capped by site plan (Sept 10 approved for 3) |
| **3. Merch** | **Capped at ~$440 of sellable stock** | Booth order #28379886.1, paid 8/25, $331.98, 13 lines / 44 pieces | Capped by inventory, and the cap is the problem |
| **4. Sponsors** | **$0.00** | No deck. No conversations. No pipeline | **No ceiling** |

### Layer 1 — Tickets
Fully instrumented and the only thing currently working. The constraints are known and specific:
- **Shotgun followers = 9.** That is the top-of-funnel constraint.
- **The hero-render bug is worth more than any campaign.** Gold Rush sat at 5,482 visits and 2 sales, a 0.04% conversion, because a broken file in the 16:9 video trailer slot rendered a black rectangle instead of the cover image. Load the public page as a buyer before every promo push. Every time.
- **Shotgun early payout works pre-event.** Banking, event balance, New Transfer, 4-digit emailed code, 2 to 3 business days. This is the cash-flow valve for a business with $0 in the bank. Sell about 4 days before money is needed.
...
- **Mystic Holistic Healing** (name approximate, **confirm the exact spelling before printing it anywhere**), Monique's daughter, massage table and chill/recovery tent. Terms unknown. For an all-ages, no-alcohol, eight-hour outdoor Arizona September event this is genuinely smart and it sits naturally next to the EMT station.
...
### Layer 4 — Sponsors: the layer at $0, and the biggest opportunity in the plan

**Nothing has been sold. Ever. There is no deck.** The only sponsor-adjacent asset in the entire fact base is the Cheba Hut pitch deck, which was delivered and whose August 8 window passed unlocked.

**Why this is the biggest opportunity and not just the biggest hole:**

1. **No ceiling.** Tickets are capped by the room. Vendors are capped by the site plan. Merch is capped by inventory and cash. Sponsorship is capped by nothing except how many calls get made.
2. **No cash outlay.** Every other layer requires Ryan to spend money he does not have. A sponsor deck costs an afternoon.
3. **The proof already exists and is verified.** Ryan does not have to invent a single claim:
   - 1,300 approved capacity for Sept 10
   - 450 people through the door at SIGNAL 001, 21 artists
   - 5,500+ views on the Gold Rush ticket page
   - 1,276 IG followers on @subground.collective
   - A 22-artist roster
   - An **APPROVED A2P sole-prop SMS number**, (602) 962-7369, approved 8/26 6:55 AM, with **113 real contacts with phone numbers** exportable from Shotgun Marketing
   - **100% of SIGNAL 001 buyers were first-time buyers.** That is 450 people nobody else in Phoenix has a relationship with. It is the warmest untapped audience in the business and it is a sponsor asset, not just an email list.
4. **A nine-show slate lets you sell a season, not a night.** A brand that will not pay $500 for one show will pay $5,000 for six months of presence. The slate is the product.

**Proposed ladder. Claude's proposed pricing, NOT a quote. Ryan sets the number.** It is anchored to the one real price point in the fact base, the $150 vendor spot.

| Tier | Proposed ask | What they get |
|---|---|---|
| Table partner | $500 | Vendor spot plus logo on flyer and ticket page |
...
1. **Run Sept 10.** Setup 12 to 1 PM, event 1 to 10 PM, hard stop 10 PM, cleanup complete 11:30 PM, permit cleanup window 7 to 8 AM Sept 11.
2. **Ryan pays GALLIUM's $625 balance in cash, day-of, after performance, at load-in.** And Blade's second $250, day-of, from door money.
3. **Pull the Shotgun early payout before Sept 10** for anything that must be paid pre-show. 2 to 3 business days, so sell about 4 days ahead of the need.
4. **Capture the real numbers on the night:** actual sell-through, actual merch per head, actual vendor payments collected, actual ad conversion rate. **Those four numbers replace every ESTIMATE in section 3.** This is the most valuable output of Sept 10 after the cash.
...
12. **Google Workspace ~$22/mo**, started 8/17, cancel-or-keep is overdue.
13. **Melcher lead engine re-enables 9/11** (calendar reminder already set). It has been paused for Sept 10 focus.
14. **Fix the website: "20+ artists" should read 22.** And Ryan decides the scope on retiring legacy IYKYK from site copy, Printify products and printed cards. **All NEW content is IfYoKYK.**

### NEXT 90 DAYS · through ~Nov 24
...
| # | Risk | The real evidence | Mitigation | Owner |
|---|---|---|---|---|
| 1 | **Card frozen** | Visa ••2245 froze 8/25 when a $643.13 Melio charge cleared and a $250 Cash App push hit ~20 minutes later, tripping the fraud model. ~$857 still available, just locked. Dad said he would call in 15 to 20 minutes and did not. **While frozen: EMT deposit, Blade, porta potties AND the Instagram ads all decline** | Call the number on the back, the automated line reads available credit from the card number alone. Register an authorized-user online login. Note the card is in Ryan's name on **Mario Romero's** account with a **$1,500 limit, not $3,000**, and only the primary can request an increase | Ryan |
| 2 | **$0 cash, negative checking** | FACTS §10. Everything downstream of Sept 10 revenue. Venmo at/near zero (receiving works, spending does not). Discord $14.57 declining daily since 8/9 | **Shotgun early payout pre-event**, 2 to 3 business days, sell ~4 days ahead. **236 tickets covers the entire Sept 10 deferred pile, 18% of capacity.** Money coming IN goes to Cash App `$Ryansans`, **never Zelle into Desert Financial ••0400** while checking is negative, the overdraft eats it | Ryan |
| 3 | **Ad burn climbing to $251/day** | $2,146.08 billed Aug 6 to 26. Daily rate $76 → $127 → $172 → $211 → **$251** on 8/25 and 8/26. Last 6 days = $1,147.85, about 143 tickets at $15 just to cover | **Never judge ad spend by daily burn without dividing by clicks.** $897 ÷ 5,506 clicks = **$0.163/click**, which is efficient. Break-even conversion is **0.92%** and normal event pages run 1 to 3%. Above 0.92%, leave it running. Below 0.5% with a working page, the offer or audience is wrong, not the spend. **Someone must still look at the daily cap. Ryan clicks. Claude never touches on/off** | Ryan |
...
## 7. WHAT WE WILL NOT DO FOR MONEY

These hold at speed, under deadline, and while broke. From FACTS §15, section 1, and section 12.

- **We do not fabricate.** No invented lots, links, leads, names, phone numbers or prices. **No placeholders, ever.** If a number is unknown, we write "unknown" and name who has to confirm it.
- **We do not claim a capacity, headcount or stat that is not real.** Ryan already refused to tell a vendor "1,200 guaranteed." We use the real proof instead: 1,300 approved capacity, 450 through the door at SIGNAL 001, 5,500+ ticket-page views, vendor keeps 100% of sales with no cut.
- **We do not let an artist go unpaid or unlisted to save a dollar.** Pipeline Law 4. Today's $150 vendors and $500 department heads are DREAM's staff, and they grow at our prices only if we pay on time.
- **We do not publish a venue's exact street address** in anything public. Teasers say "Coming Soon" and the location drops to ticket holders. **The tunnel location never gets published at all.**
- **We do not publish public content without Ryan's explicit in-session approval.** Staged with Share unclicked is the correct end state.
- **Claude never moves money.** Claude fills every non-financial field. Ryan types the bank digits and presses Confirm. That split held on the Melio setup and it holds on every payment in this plan.
- **We do not sell on-site cannabis consumption.** greenphoenixfarm420 is SALES ONLY. Arizona has no legal public consumption and no licensed lounges. Glass, rigs, pipes, papers, accessories and hemp/CBD under 0.3% THC are legal to sell without a license. Actual THC product is not.
- **We do not bring alcohol onto the TUP site.** No alcohol, no open flames, no fireworks. That is why GALLIUM's rider Coors Banquet gets struck or swapped for a meal buyout.
- **We do not run unlicensed security.** Blade still owes written confirmation that all three guards hold current AZ unarmed guard licenses. If that never arrives, Access Control Security has paper at $1,140.
- **We do not skip SMS consent or the opt-out line.** Existing relationships only.
- **We do not type an SSN, tax ID or government ID into any field.**
...
- **We do not model Icehouse as profit.** Ryan's binding correction, 8/22.
- **Show money and life money never touch.** Pipeline Law 1.

---

## 8. DECISION QUEUE

Only Ryan can make these. One line each, with what it unblocks.
...
| 7 | **Ask Synesthesia for the Friday rate and the Saturday Oct 31 rate in one message** | Both Oct 31 and Nov 6 contracts |
| 8 | **Yes or no on booking Oct 31** | The largest single swing in the six months. Saturday Halloween is gone if it is not claimed |
| 9 | **Look at the ad daily cap** | Whether $251/day continues. Claude never touches the switch |
| 10 | **Reorder merch by Sept 1, or accept ~$440** | The named, quantified revenue leak |
...
| 18 | **Google Workspace ~$22/mo: keep or cancel** | Overdue since 8/17 |
| 19 | **Open Ben Bethel's SGC risk doc** `1x80WLT0f_xnbbBf1C9nodT3Onm9N6r1u8_258YUkwqQ` | Never been opened. Surface it before more vendor spend locks |
| 20 | **Scope on retiring legacy IYKYK** from site copy, Printify products and printed cards | Brand consistency. All new content is already IfYoKYK |
